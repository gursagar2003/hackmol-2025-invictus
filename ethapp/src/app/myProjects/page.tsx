...
export default function MyProject() {  // Changed from myProject to MyProject
    ...
    return (
        ...
        <div className="p-4 rounded-xl border-1 border-gray-400 dark:border-gray-800">
            <div className="flex">
                <div className="mr-4">
                    <img src={repo.image_url || 'back_2.jpg'} className="rounded" width={48} height={48} alt="avatar" />
                </div>
                <div>
                    <h3>
                        {repo.projectName}  
            ...
            <div className='space-x-2 text-[14px] mt-2'>
                                    <Link href={{
                                    ...
                                    <button className='bg-white px-4 py-2 rounded-xl text-black'>
                                        Assign Issue 
                                    </button>
                                </Link>
                                <Link href={{
